...
if __name__ == "__main__":
    ...
    parser.add_argument("-nm", "--n_modes", type=int, default=2, help="Number of modes per block (default: 1)")
    parser.add_argument("-e", "--entanglement", type=int, default=1, help="Target entanglement level (default: 1)")
    parser.add_argument("-no", "--num_ops", type=int, default=36, help="Number of measurement operators")
